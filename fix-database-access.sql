...
-- Disable RLS for ConversationMemory table
...
SELECT 'ConversationMemory records:' as info, COUNT(*) as count FROM "ConversationMemory"
UNION ALL
SELECT 'n8n_chat_histories records:' as info, COUNT(*) as count FROM "n8n_chat_histories";

-- Show sample data to confirm access
SELECT 'Sample ConversationMemory data:' as info;
SELECT id, sender, recipient, message, created_at FROM "ConversationMemory" LIMIT 3;
